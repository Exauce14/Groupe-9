...
-- Hash généré: 2026-02-02T22:56:55.467Z
-- ============================================
...
VALUES
    ('jean.dupont@email.com',      '$2b$10$k3oxk.P92R/ampL8StNbfewkstrFSBhGNlpc989xICCAOpmKZvPJC', 'Jean',   'Dupont',    '514-555-0101', '123 Rue Principale, Montréal, QC H2X 1Y5', 'user'),
    ('marie.tremblay@email.com',   '$2b$10$k3oxk.P92R/ampL8StNbfewkstrFSBhGNlpc989xICCAOpmKZvPJC', 'Marie',  'Tremblay',  '514-555-0102', '456 Avenue du Parc, Montréal, QC H3G 2K8', 'user'),
    ('pierre.gagnon@email.com',    '$2b$10$k3oxk.P92R/ampL8StNbfewkstrFSBhGNlpc989xICCAOpmKZvPJC', 'Pierre', 'Gagnon',    '514-555-0103', '789 Blvd Saint-Laurent, Montréal, QC H2X 2V1', 'user'),
    ('admin@banque.com',           '$2b$10$k3oxk.P92R/ampL8StNbfewkstrFSBhGNlpc989xICCAOpmKZvPJC', 'Admin',  'Système',   '514-555-0001', '1000 Rue de la Banque, Montréal, QC H3B 4W5', 'admin');
